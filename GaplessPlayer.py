...
class AudioPlayer:
    def __init__(self, callbacks={}):
        ...
        InOverflowBufferSize = 600                          # The decoder seems to always take less than 600 bytes at a time from the buffer when decoding
    ...
    def ReadHeader(self, url, port=80):
        ...
        if self.audio_out == None:
            self.audio_out = I2S(0, sck=sck_pin, ws=ws_pin, sd=sd_pin, mode=I2S.TX, bits=bits_per_sample, format=I2S.STEREO if channels == 2 else I2S.MONO, rate=sample_rate, ibuf=self.ChunkSize)
